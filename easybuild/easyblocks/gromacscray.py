...
class gromacscray(CMakeMake):
    ...
    def configure_step(self):
        ...
        if LooseVersion(self.version) < LooseVersion('4.6'):
            ...
            if cuda:
                ...
                # without cuda, prefer static libraries, if available
                self.cfg.update('configopts', "-DGMX_GPU=OFF -DGMX_PREFER_STATIC_LIBS=ON")
        ...
        out = super(gromacscray, self).configure_step()
    ...
    def make_module_req_guess(self):
        ...
        guesses = super(gromacscray, self).make_module_req_guess()
        guesses.update({
    ...
    def sanity_check_step(self):
        ...
        super(gromacscray, self).sanity_check_step(custom_paths=custom_paths)
